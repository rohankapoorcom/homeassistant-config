import{_ as e,t as a,a4 as t,x as s,dc as r,dl as i,dm as d,dn as o,dk as l,r as n,eU as h,eJ as c,d3 as m,a as p,d4 as y,d6 as _,n as u}from"./card-fb6e9222.js";import{e as $,c as v}from"./image-player-5f97e75a.js";import{d as g}from"./dispatch-live-error-b929e6f6.js";import{V as f,h as b,M as w,m as P}from"./audio-5464cc91.js";customElements.whenDefined("ha-web-rtc-player").then((()=>{const c=customElements.get("ha-web-rtc-player");let m=class extends c{constructor(){super(...arguments),this._mediaPlayerController=new f(this,(()=>this._video),(()=>this.controls))}async getMediaPlayerController(){return this._mediaPlayerController}async _startWebRtc(){await super._startWebRtc(),this.isConnected||this._cleanUp()}render(){return this._error?(g(this),t({type:"error",message:this._error,context:{entity_id:this.entityid}})):s`
        <video
          id="remote-stream"
